...
ActiveRecord::Schema.define(version: 20150108215327) do
  ...
  add_index "graffitis", ["artists_id"], name: "index_graffitis_on_artists_id", using: :btree
  add_index "graffitis", ["locations_id"], name: "index_graffitis_on_locations_id", using: :btree
  add_index "graffitis", ["slug"], name: "index_graffitis_on_slug", unique: true, using: :btree
  ...
  add_index "instagram_arts", ["uid"], name: "index_instagram_arts_on_uid", unique: true, using: :btree
